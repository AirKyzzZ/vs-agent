...
import {
  ...
  OID4VC_CREDENTIAL_CONFIGURATIONS,
  OID4VC_ISSUER_ID,
  OID4VC_VERIFIER_ID,
      ...
      ...(openid4vcSetup
        ? [
            openid4vcSetup.setupOpenId4Vc({
              ...
              credentialConfigurations: OID4VC_CREDENTIAL_CONFIGURATIONS,
              ...(OID4VC_ISSUER_ID ? { issuerId: OID4VC_ISSUER_ID } : {}),
              ...(OID4VC_VERIFIER_ID ? { verifierId: OID4VC_VERIFIER_ID } : {}),
